...
# 簡單的 Assembly 模板，只用算數/立即數/Load/Store
ASM_TPL = {
...
def main():
    ...
    # 4) 生成 cand_feat.h
    # 4.1) 載入 Vectorizer & TFLite，取得量化參數
    ...
    print(f"Using scale={scale}, zero_point={zero_point} for feature quantization")
    ...
    print("Generated headers:", OUT_CAND_H, OUT_FEAT_H)
